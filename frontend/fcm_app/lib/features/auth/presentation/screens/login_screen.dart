  ...
  final List<Map<String, dynamic>> _seasons = [
    {
      'name': 'SUMMER',
      'label': 'HOT & VIBRANT',
      // 50% Darker: #996E2E -> #4C3717, #1A120B -> #0D0905
      'colors': [const Color(0xFF4C3717), const Color(0xFF0D0905)],
      'accent': const Color(0xFFFFB74D),
      'exposure': 1.5, // Bright daylight
      'shadowIntensity': 1.0, // Strong shadows
      'shadowSoftness': 0.2, // Sharp shadows
      'weather': 'haze',
    },
    {
      'name': 'RAINY',
      'label': 'SOFT & HUMID',
      // 50% Darker: #2E6D67 -> #173633, #0F1417 -> #070A0B
      'colors': [const Color(0xFF173633), const Color(0xFF070A0B)],
      'accent': const Color(0xFF4DB6AC),
      'exposure': 0.7, // Dim/Overcast
      'shadowIntensity': 0.5, // Subtle shadows
      'shadowSoftness': 1.0, // Very soft shadows
      'weather': 'rain',
    },
    {
      'name': 'WINTER',
      'label': 'CRISP & COLD',
      // 50% Darker: #4D7F96 -> #263F4B, #0C0F1C -> #06070E
      'colors': [const Color(0xFF263F4B), const Color(0xFF06070E)],
      'accent': const Color(0xFF81D4FA),
      'exposure': 1.1, // Clean/Neutral
      'shadowIntensity': 1.0, // Regular shadows
      'shadowSoftness': 0.5, // Balanced shadows
      'weather': 'snow',
    },
  ];
  ...
  Widget _buildBackground(double screenWidth, bool isMobile) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        final Color seasonAccent = Color.lerp(
              previousSeason['accent'] as Color,
              currentSeason['accent'] as Color,
              t,
            )!;

        // Original 5.0 Theme/Season Blending (0.85 blend for dark mode)
        ...
        // Base theme colors from DashboardTheme (approximate for login screen state)
        const themeBg1 = Color(0xFF0D0D0E);
        const themeBg2 = Color(0xFF1A1A1C);
        
        final List<Color> mergedColors = [
          seasonColor1,
          seasonColor2,
        ];
        ...
        return Stack(
          children: [
            // Original 5.0 Radial Gradient Background
            Positioned.fill(
                child: Container(
                    decoration: BoxDecoration(
