...
class _ModelViewScreenState extends State<ModelViewScreen>
              ...
              actions: [
                TextButton(
                  onPressed: () {
                    ...
                    try {
                      ...
                      js.context.callMethod('toggleInteractable',
                          [true]); // Re-enable interaction
                    } catch (e) {
                      print("JS Error: $e");
                    }
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text('เพิ่ม "$objectName" ลงในรายการแล้ว',
                            style: GoogleFonts.kanit(color: Colors.white)),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key:
          _scaffoldKey, // Still useful for general scaffold features, but not for this custom drawer
        ...
        children: [
          ...
          AnimatedContainer(
            ...
            child: ClipRect(
              ...
              child: OverflowBox(
                // Allow content to be full width even when container is small (prevents squishing)
                minWidth: 350,
                maxWidth: 350,
                ...
                AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    return Opacity(
                      ...
                      child: IgnorePointer(
                        ignoring: _uiOpacityAnim.value <
                            0.9, // Disable interaction until mostly visible
                        child: child,
                      ),
                    );
                  },
                            ...
                            if (!_isSidebarOpen) ...[
                              IconButton(
                                icon: const Icon(Icons.menu,
                                    color: Color(0xFFC5A059), size: 28),
                                onPressed: () {
                                  setState(() {
