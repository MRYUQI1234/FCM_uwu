...
class CommonAreaRequestDialog extends StatefulWidget {
  ...
  @override
  State<CommonAreaRequestDialog> createState() =>
      _CommonAreaRequestDialogState();
}
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              terminalText(
                                  "SERVICE_REQUEST // INTERNAL_PROTOCOL",
                                  fontSize: 9,
                                  color:
                          ...
                          Material(
                            ...
                            child: IconButton(
                              ...
                              icon: Icon(Icons.close_rounded,
                                  color:
                                      DashboardTheme.textMain.withOpacity(0.5),
                                  size: 24),
                            ),
                          ),
                        ],
                        ...
                        children: [
                          Expanded(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                terminalText("ISSUE_DESCRIPTION",
                                    fontSize: 10,
                                    color: DashboardTheme.textPale,
                                    letterSpacing: 1),
                                const SizedBox(height: 12),
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        color: DashboardTheme.border,
                                        style: BorderStyle
                                            .solid), // Dashed border usually better but solid matches style
                                  ),
                                  child: Center(
                                    child: Column(
                                      mainAxisAlignment:
                          ...
                          Expanded(
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    color: _isUrgent
                                        ? DashboardTheme.error.withOpacity(0.5)
                                    ...
                                    children: [
                                      Text("HIGH PRIORITY PROTOCOL",
                                          style: GoogleFonts.notoSans(
                                              ...
                                              fontSize: 13)),
                                      Text(
                                          "Flag this issue for immediate attention",
                                          style: GoogleFonts.notoSans(
                                              color: DashboardTheme.textPale,
                                              fontSize: 10)),
                                    ],
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          terminalText("ASSIGN_TECHNICIAN (OPTIONAL)",
                              fontSize: 10,
                              color: DashboardTheme.textPale,
                              letterSpacing: 1),
                          const SizedBox(height: 12),
  ...
  Widget _buildTextField(
    ...
    return Container(
      ...
      child: TextField(
        ...
        style:
            GoogleFonts.notoSans(color: DashboardTheme.textMain, fontSize: 14),
        maxLines: maxLines,
        decoration: InputDecoration(
          hintText: hint,
          hintStyle: GoogleFonts.notoSans(
