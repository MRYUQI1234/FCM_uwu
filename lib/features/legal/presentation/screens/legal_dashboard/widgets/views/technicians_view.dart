...
class _TechniciansViewState extends State<TechniciansView> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          terminalText("SYS.ADMIN // PERSONNEL REGISTRY",
                              fontSize: 10,
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          ElevatedButton.icon(
                            onPressed: _teamDraftMembers.isEmpty
                                ? null
                                : () => _showSaveTeamDialog(),
                            icon: const Icon(Icons.folder_special_rounded,
                                size: 16),
                            label: Text("บันทึกเป็น Preset",
                                style: GoogleFonts.notoSans(
                  ...
                  // ── DYNAMIC VIEW BODY ──
                  if (_activeTab == RegistryTab.teams &&
                      _selectedTeamPreset == null &&
                      !_isCreatingTeam)
                    Expanded(
                      child: ValueListenableBuilder<List<TeamPreset>>(
                        valueListenable:
                            RepairRepository.instance.teamPresetsNotifier,
                        builder: (context, presets, _) {
                          if (presets.isEmpty)
                            return Center(
                    ...
                    if (_activeTab == RegistryTab.teams &&
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          onTap: () =>
                              setState(() => _selectedTeamPreset = null),
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(Icons.arrow_back_ios_new_rounded,
                                    color: DashboardTheme.primary, size: 14),
                                const SizedBox(width: 8),
                                Text(" กลับไปที่หน้ารายชื่อทีม",
                                    style: GoogleFonts.notoSans(
                    ...
                    Expanded(
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) => _buildStaffRow(
                            context, _getDisplayPersonnel()[index]),
                      ),
                    ),
                  ],
                ],
  ...
  List<Map<String, dynamic>> _getDisplayPersonnel() {
    if (_isCreatingTeam || _activeTab == RegistryTab.staffs) {
      ...
      return widget.technicians
          .where((t) => _selectedTeamPreset!.memberNames.contains(t['name']))
          .toList();
    }
  }
          ...
          children: [
            Row(
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("${preset.memberNames.length} Members",
                          style: GoogleFonts.notoSans(
                ...
                Icon(Icons.arrow_forward_ios_rounded,
                    color: DashboardTheme.textPale.withOpacity(0.5), size: 16),
              ],
            ),
            const SizedBox(height: 16),
            Wrap(
              spacing: 6,
              children: preset.memberNames
                  .take(3)
                  .map((name) => Container(
                        padding: const EdgeInsets.symmetric(
            ...
            if (preset.memberNames.length > 3)
              Padding(
                ...
                child: Text("+${preset.memberNames.length - 3} others...",
                    style: GoogleFonts.notoSans(
                        color: DashboardTheme.textPale, fontSize: 9)),
              ),
          ],
        ),
      ),
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: isTeamSelected && _isCreatingTeam
                    ...
                    : (isHovered
                        ? DashboardTheme.primary.withOpacity(0.05)
                        : Colors.transparent),
                borderRadius: BorderRadius.circular(12),
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      flex: 3,
                      child: InkWell(
                        onTap: _isCreatingTeam
                            ? null
                            : () => _showTechnicianDossier(context, tech),
                        child: Text(
                          techName,
                          style: GoogleFonts.notoSans(
                            color: isTeamSelected && _isCreatingTeam
                            ...
                            fontSize: 14,
                            decoration:
                                isHovered && isActive && !_isCreatingTeam
                        ...
                        child: AnimatedOpacity(
                          ...
                          child: PopupMenuButton<String>(
                            icon: Icon(Icons.more_horiz_rounded,
                                color: DashboardTheme.textPale, size: 20),
                            color: DashboardTheme.surface,
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(12)),
                            onSelected: (value) {
                              ...
                              PopupMenuItem(
                                  ...
                                  child: Row(children: [
                                    const Icon(Icons.delete_rounded,
                                        color: DashboardTheme.error, size: 16),
                                    const SizedBox(width: 10),
                                    Text("ลบบุคลากร",
                                        style: GoogleFonts.notoSans(
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                autofocus: true,
                style: GoogleFonts.notoSans(
                    color: DashboardTheme.textMain, fontSize: 15),
  ...
  void _showDeletePresetDialog(TeamPreset preset) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        backgroundColor: DashboardTheme.surface,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
        title: Text('ลบทีม "${preset.name}" ?',
            style: GoogleFonts.notoSans(
                color: DashboardTheme.error,
                fontSize: 16,
                fontWeight: FontWeight.w900)),
        content: Text("ทีมนี้มี ${preset.memberNames.length} สมาชิก",
            style: GoogleFonts.notoSans(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              Navigator.pop(ctx);
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content: Text('ลบทีม "${preset.name}" แล้ว',
                    style: GoogleFonts.notoSans(fontWeight: FontWeight.w600)),
  ...
  void _showDeleteConfirmation(
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        backgroundColor: DashboardTheme.surface,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
        title: Text("ยืนยันที่จะลบบุคลากรหรือไม่",
            style: GoogleFonts.notoSans(
                color: DashboardTheme.error,
                fontSize: 16,
                fontWeight: FontWeight.w900)),
        content: Text("ลบ ${tech['name']} ออกจากระบบ?",
            style: GoogleFonts.notoSans(
                color: DashboardTheme.textSecondary, fontSize: 13)),
        actions: [
          TextButton(
